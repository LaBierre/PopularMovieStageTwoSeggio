...
public class MovieContract {
    ...
    public static final class MovieEntry implements BaseColumns
    {
        ...
        public final static String COLUMN_MOVIE_AUTHOR ="author";
        public final static String COLUMN_MOVIE_REVIEW ="review";
        public final static String COLUMN_MOVIE_KEY ="key";
        public final static String COLUMN_MOVIE_TRAILER  ="trailer";

        //DONE: define the other columns
